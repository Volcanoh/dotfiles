...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(cc-mode hungry-delete swiper)
...
you should place you code here."
  ...
  (setq org-agenda-files '("~/KuaiPan/org-notes/"))
  ...
  (add-hook 'LaTeX-mode-hook (lambda ()
                               (push
                                '("xelatex" "xelatex --shell-escape %s" TeX-run-command nil t
...
(custom-set-variables
 ...
 '(pyim-dicts
   (quote
    ((:name "BigDict-01" :file "/home/volcano/.emacs.d/.cache/pyim-bigdict.pyim" :coding utf-8-unix :dict-type pinyin-dict)))))
(custom-set-faces
